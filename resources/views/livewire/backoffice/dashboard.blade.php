<div class="font-poppins">
    ...
    <div class="hidden lg:grid lg:grid-rows-2 w-full px-12 py-12  gap-6"> <!-- MainContainer -->
    ...
    <!--  Mobile vers -->
    <div class="lg:hidden w-full px-6 py-6 grid grid-rows-2 gap-6"> <!-- MainContainer -->
        <div class="row-span-1"> <!-- Atas -->
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-4">
                    <div class="flex flex-col gap-4">
                        <div class="bg-white rounded-md px-6 py-2 shadow-md flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                <span class="text-2xl">
                                    @if ($currentTimeOfDay == 'Siang')
                                        <svg id='Sun_24' width='24' height='24' viewBox='0 0 24 24'
                        ...
                        <div class="col-span-2 p-4 bg-white rounded-md shadow-lg">
                            ...
                            <div wire:ignore>
                                <canvas id="grafikLikedItems2" class="max-h-full max-w-full"></canvas>
                            </div>
                            @script
                            <script>
                                const ctx = document.getElementById('grafikLikedItems2');
