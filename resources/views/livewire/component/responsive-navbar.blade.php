    ...
    <div class="bg-maincolor w-full text-white px-4 py-2 flex items-center justify-between">
        <div class="relative group shrink-0 pr-8">
            <a href="#mainsearch" title="" class="flex items-center">
                <span
                    class="z-20 font-poppins text-gray-200 font-bold text-2xl ease-in duration-200 hover:translate-x-2 lg:hover:scale-110 hover:text-white">Aneka Sarana Teknik</span>
                <img src="{{ asset('assets/logo/main.png') }}" alt="SaDiga"
                    class="hidden lg:block w-6 z-10 absolute -left-16 transform translate-x-20 transition-all duration-500 ease-in-out opacity-0 group-hover:translate-x-1 group-hover:opacity-100 group-hover:w-12">
            </a>
        </div>
