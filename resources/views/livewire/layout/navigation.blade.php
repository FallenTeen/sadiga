...
<nav x-data="{ open: false }" class="bg-maincolor dark:bg-maincolordark border-b border-gray-100 dark:border-gray-700 font-poppins">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-8 w-3/5">
                <div class="hidden sm:flex sm:items-center sm:ms-6 sm:justify-around justify-around w-full">
                    ...
                    <x-nav-link 
                        :href="route('productmanage.index')" :active="in_array(request()->route()->getName(), ['productmanage.index', 'productmanage.create', 'productmanage.edit'])" 
                        wire:navigate>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <x-nav-link :href="route('servicemanage')" :active="request()->routeIs('servicemanage')" wire:navigate>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white dark:text-gray-400 dark:bg-gray-800 hover:text-gray-200 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
